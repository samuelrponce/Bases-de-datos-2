...
## VARCHAR2(50). Además, crear una secuencia para esta tabla y que se gestione    ##
## la misma a través de un trigger para tener valores autoincrementables en el    ##
## campo código de esta tabla. Luego crear un trigger para la tabla categorías,   ##
## se debe ejecutar después de un UPDATE en esta tabla, este trigger debe guardar ##
## un registro en la tabla LOGS con la información de la operación que se realizó.##
##################################################################################*/
...
/*#######################################################################
## Creacion del trigger para la tabla categorías, se ejecutara después ##
