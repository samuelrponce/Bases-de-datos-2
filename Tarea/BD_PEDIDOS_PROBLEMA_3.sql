/*####################################################################################### 
## 3) Crear un trigger para la tabla PROVEEDORES, se debe ejecutar despu�s de un       ##
## INSERT o un UPDATE o un DELETE en esta tabla, este trigger debe guardar un registro ##
## en la tabla LOGS con la informaci�n de la operaci�n que se realiz�. Adem�s, se debe ##
## controlar cualquier error que pueda suceder y en caso de error se debe insertar un  ##
## registro en la tabla LOGS con la informaci�n del error. El trigger es el que debe   ##
